...
export const metadata: Metadata = {
  ...
  description:
    "Visit P60 Cannabis at 1938 Weston Rd, York, ON M9N 1W2. The storefront is open 24 hours daily. Walk-ins welcome.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "1938 Weston Rd, York. The storefront is open 24 hours daily.",
  },
};
