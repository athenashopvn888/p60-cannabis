...
export function getItemData(category: string, name: string): ItemEffects {
  ...
  if (cat === "EDIBLES") {
    return {
      ...
      metaDescription: `Buy ${name} cannabis edibles in York at P60 Cannabis. Consistent, discreet, and long-lasting effects. Walk-in available 24/7.`,
  ...
  if (cat.includes("VAPE")) {
    return {
      ...
      metaDescription: `Shop ${name} vape pens and cartridges in York at P60 Cannabis. Fast-acting and potent. Walk-in available 24/7.`,
  ...
  if (cat === "CONCENTRATES") {
    return {
      ...
      metaDescription: `Buy ${name} cannabis concentrate in York at P60 Cannabis. Highly potent and pure extracts. Walk-in available 24/7.`,
  ...
  if (cat === "PREROLLS") {
    return {
      ...
      metaDescription: `Get ${name} pre-rolled joints in York at P60 Cannabis. Premium flower, perfectly rolled. Walk-in available 24/7.`,
  ...
  if (cat === "MAGIC & OTHERS") {
    return {
      ...
      metaDescription: `Shop ${name} magic mushrooms and psilocybin products in York at P60 Cannabis. High quality and consistent. Walk-in available 24/7.`,
  ...
  return {
    ...
    metaDescription: `Buy ${name} in York at P60 Cannabis. Premium quality and best prices. Walk-in available 24/7.`,
