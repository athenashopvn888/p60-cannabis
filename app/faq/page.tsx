...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about P60 Cannabis in York. Hours, location, products, pricing, promotions, and everything you need to know before visiting.",
  alternates: {
...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! P60 Cannabis is walk-in only. Just show up anytime — we're open Open 24 Hours." },
