...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/info/york-weed-dispensary", destination: "/weed-dispensary-york", permanent: true },
      { source: "/info/dispensary-near-me-york", destination: "/weed-dispensary-york", permanent: true },
      { source: "/info/cheap-weed-york", destination: "/budget-weed", permanent: true },
