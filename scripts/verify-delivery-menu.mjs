...
assert(home.includes('href="/weed-delivery-york"') && home.includes("width={1774}") && home.includes("height={887}") && home.includes("priority"));
...
assert(nav.includes('href="/exotic-weed"') && nav.includes("Store Menu"));
assert(nav.includes('href="/weed-delivery-york"') && nav.includes("Weed Delivery") && nav.includes('aria-label="Choose a menu"'));
...
assert(deliveryPage.includes('canonical: "https://www.p60cannabis.com/weed-delivery-york"') && !deliveryPage.includes("noindex"));
